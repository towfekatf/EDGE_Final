        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="{{ route("Admin.restaurant.index") }}"
               class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                <i class="fas fa-eye fa-sm text-white-50"></i> Restaurants
            </a>
        </div>
            ...
            <div class="card-body">
                <form action="{{ route("Admin.restaurant.update", $restaurant->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="contact_info" value="{{ old("contact_info", $restaurant->contact_info) }}"
                                   name="contact_info">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="operating_hours" value="{{ old("operating_hours", $restaurant->operating_hours) }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <textarea name="address" id="address" class="form-control">{{ old("address", $restaurant->address) }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="checkbox" class="form-check-input" id="is_available" name="is_available" {{ $restaurant->is_available ? 'checked' : '' }}>
